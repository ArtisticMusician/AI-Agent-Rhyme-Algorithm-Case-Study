// src/tests/rhyme-algorithm-v1.spec.ts

import { isPerfectRhymeV1 } from '../algorithms/rhyme-algorithm-v1';
import testPerfectRhymes from '../data/TestPerfect.json';
import dictionary from '../data/dictionary.json';

describe('Perfect Rhyme Algorithm V1 Evaluation', () => {
  ...
  it('should evaluate the F1-Score for Algorithm V1', () => {
    let truePositives = 0;
    ...
    for (const word in dictionary) {
      ...
      if (isPerfectRhymeV1(targetWord, word)) {
    ...
    console.log(`\n--- Algorithm V1 Results for "${targetWord}" ---`);
