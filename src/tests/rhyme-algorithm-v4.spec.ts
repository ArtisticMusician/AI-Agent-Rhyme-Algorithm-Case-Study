// src/tests/rhyme-algorithm-v4.spec.ts

import { isPerfectRhymeV4 } from '../algorithms/rhyme-algorithm-v4';
import testPerfectRhymesData from '../data/TestPerfect2.json'; // Use TestPerfect2.json
import dictionary from '../data/dictionary.json';

describe('Perfect Rhyme Algorithm V4 Evaluation', () => {
  const targetWord = 'test';
  // TestPerfect2.json is a flat object where keys are the words
  ...
  it('should evaluate the F1-Score for Algorithm V4', () => {
    let truePositives = 0;
    ...
    for (const word in dictionary) {
      ...
      if (isPerfectRhymeV4(targetWord, word)) {
    ...
    console.log(`\n--- Algorithm V4 Results for "${targetWord}" ---`);
